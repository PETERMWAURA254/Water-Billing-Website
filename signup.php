...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $database = "water_billing_system"; // Replace with your database name
    ...
    $insert_sql = "INSERT INTO register (phone, user_name, email, user_location, pass_w) VALUES ('$phone', '$name', '$email', '$location', '$hashed_password')";
